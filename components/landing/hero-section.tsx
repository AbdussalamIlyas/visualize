...
export function HeroSection() {
  return (
    <section className="pb-16 pt-14 sm:pb-20 sm:pt-20">
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.82fr)_minmax(30rem,42rem)] lg:gap-14">
          <motion.div
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                <h1 className="max-w-4xl font-[family:var(--font-display)] text-5xl font-semibold leading-[1.02] tracking-tight text-white sm:text-6xl lg:text-7xl">
                  Watch a jet engine make thrust, one stage at a time.
                </h1>
                <p className="max-w-xl text-lg leading-8 text-[var(--color-muted)] sm:text-xl">
                  One focused page. Short cues. The visual does the teaching.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap gap-3">
              <LinkButton href="/concept/how-a-jet-engine-works">
                Open flagship explainer
              </LinkButton>
            </div>
